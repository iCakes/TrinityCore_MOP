...
enum Opcodes
{
    ...
    CMSG_AUTH_SESSION                                 = 0x08A, //MOP 5.0.5b
    CMSG_CAST_SPELL                                   = 0x1BB, //16016
    CMSG_CHANNEL_MODERATOR                            = 0x0581,//MOP ??
    CMSG_CHAR_CREATE                                  = 0x332, //MOP 5.0.5b
    CMSG_CHAR_DELETE                                  = 0x944, //MOP 5.0.5b
    CMSG_CHAR_ENUM                                    = 0x576, //MOP 5.0.5b
    ...
    CMSG_LOG_DISCONNECT                               = 0x48F, // 5.0.5b
    CMSG_PET_ACTION                                   = 0x04BF,//16016 ??
    CMSG_PING                                         = 0x4EB, //mop 5.0.5b
    CMSG_PLAYER_LOGIN                                 = 0x203, //MOP 5.0.5B
    CMSG_WORLD_LOGIN                                  = 0x643, //MOP 5.0.5B
    CMSG_PLAYER_LOGOUT                                = 0xCE0, //MOP 5.0.5B
    CMSG_QUESTGIVER_COMPLETE_QUEST                    = 0x01B3,//16016 ??
    CMSG_READY_FOR_ACCOUNT_DATA_TIMES                 = 0x9A2, //MOP 5.0.5B
    CMSG_REALM_SPLIT                                  = 0x820, //MOP 5.0.5b
    CMSG_REQUEST_ACCOUNT_DATA                         = 0x60,  //MOP 5.0.5B
    MSG_VERIFY_CONNECTIVITY                           = 0x4F57,//MOP 5.0.5b
    SMSG_ACCOUNT_DATA_TIMES                           = 0xC4B, //MOP 5.0.5b
    SMSG_ADDON_INFO                                   = 0x9C6, //MOP 5.0.5b
    SMSG_AUTH_CHALLENGE                               = 0x523, //MOP 5.0.5b
    SMSG_AUTH_RESPONSE                                = 0xE20, //MOP 5.0.5b
    SMSG_CHAR_CREATE                                  = 0xC15, //MOP 5.0.5b
    SMSG_CHAR_DELETE                                  = 0x936, //MOP 5.0.5b
    SMSG_CHAR_ENUM                                    = 0xE28, //MOP 5.0.5b
    SMSG_CLIENTCACHE_VERSION                          = 0x956, //MOP 5.0.5b
    SMSG_PONG                                         = 0xAE0, //mop 5.0.5b
    SMSG_REALM_SPLIT                                  = 0xCCD, //MOP 5.0.5B
    SMSG_TUTORIAL_FLAGS                               = 0x8AE, //MOP 5.0.5b
    CMSG_MESSAGECHAT_SAY                              = 0x61A, //MOP 5.0.5B
    CMSG_MESSAGECHAT_WHISPER                          = 0xA8,  //MOP 5.0.5B
    CMSG_MESSAGECHAT_YELL                             = 0x6E5, //MOP 5.0.5B
    CMSG_RANDOMIZE_CHAR_NAME                          = 0x044, //mop 5.0.5b
    SMSG_RANDOMIZE_CHAR_NAME                          = 0xA9B, //MOP 5.0.5B
    SMSG_ACTION_BUTTONS                               = 0xE34, //MOP 5.0.5B
    SMSG_ALL_ACHIEVEMENT_DATA                         = 0xB64, //MOP 5.0.5B
    SMSG_FEATURE_SYSTEM_STATUS                        = 0xB5B, //MOP 5.0.5B
    SMSG_HOTFIX_INFO                                  = 0xF86, //MOP 5.0.5B -MAYBE
    SMSG_HOTFIX_NOTIFY                                = 0xEE0, //MOP 5.0.5B
    SMSG_INIT_CURRENCY                                = 0xAE5, //MOP 5.0.5B -MAYBE
    SMSG_LOAD_CUF_PROFILES                            = 0xFC9, //MOP 5.0.5B
    SMSG_SEND_UNLEARN_SPELLS                          = 0xFD7, //MOP 5.0.5B
    ...
    CMSG_MESSAGECHAT_ADDON_BATTLEGROUND               = 0x0040,
    CMSG_MESSAGECHAT_ADDON_GUILD                      = 0x0041,
    CMSG_MESSAGECHAT_ADDON_OFFICER                    = 0x0042,
    CMSG_MESSAGECHAT_ADDON_PARTY                      = 0x0043,
    CMSG_MESSAGECHAT_ADDON_RAID                       = 0x0044,
    CMSG_MESSAGECHAT_ADDON_WHISPER                    = 0x0045,
    CMSG_MESSAGECHAT_AFK                              = 0x0005,
    CMSG_MESSAGECHAT_BATTLEGROUND                     = 0x000A,
    CMSG_MESSAGECHAT_CHANNEL                          = 0x0002,
    CMSG_MESSAGECHAT_DND                              = 0x0006,
    CMSG_MESSAGECHAT_EMOTE                            = 0x0007,
    CMSG_MESSAGECHAT_GUILD                            = 0x0003,
    CMSG_MESSAGECHAT_OFFICER                          = 0x0004,
    CMSG_MESSAGECHAT_PARTY                            = 0x0008,
    CMSG_MESSAGECHAT_RAID                             = 0x0009,
    CMSG_MESSAGECHAT_RAID_WARNING                     = 0x000C,
    CMSG_MINIGAME_MOVE                                = 0x0000,
    CMSG_MOUNTSPECIAL_ANIM                            = 0x0000,
    CMSG_MOVE_CHARM_TELEPORT_CHEAT                    = 0x0000,
    CMSG_MOVE_CHNG_TRANSPORT                          = 0x0037,
    ...
    CMSG_MOVE_NOT_ACTIVE_MOVER                        = 0x0039,
    ...
    CMSG_REQUEST_VEHICLE_NEXT_SEAT                    = 0x0011,
    CMSG_REQUEST_VEHICLE_PREV_SEAT                    = 0x0010,
    CMSG_REQUEST_VEHICLE_SWITCH_SEAT                  = 0x0012,
    ...
    MSG_MOVE_START_ASCEND                             = 0x0025,
    MSG_MOVE_START_BACKWARD                           = 0x0026,
    MSG_MOVE_START_DESCEND                            = 0x0027,
    MSG_MOVE_START_FORWARD                            = 0x0028,
    MSG_MOVE_START_PITCH_DOWN                         = 0x0029,
    MSG_MOVE_START_PITCH_UP                           = 0x002A,
    MSG_MOVE_START_STRAFE_LEFT                        = 0x002B,
    MSG_MOVE_START_STRAFE_RIGHT                       = 0x002C,
    MSG_MOVE_START_SWIM                               = 0x002D,
    MSG_MOVE_START_TURN_LEFT                          = 0x002E,
    MSG_MOVE_START_TURN_RIGHT                         = 0x002F,
    MSG_MOVE_STOP                                     = 0x0030,
    MSG_MOVE_STOP_ASCEND                              = 0x0031,
    MSG_MOVE_STOP_PITCH                               = 0x0032,
    MSG_MOVE_STOP_STRAFE                              = 0x0033,
    MSG_MOVE_STOP_SWIM                                = 0x0034,
    MSG_MOVE_STOP_TURN                                = 0x0035,
