...
enum Anim
{
    ...
    ANIM_EMOTE_FLYSNIFF                    = 507,
    ANIM_ATTACK_FIST1H                     = 508,
    ANIM_FLY_ATTACKFIST1H                  = 509,
    ANIM_ATTACK_FIST1HOFF                  = 510,
    ANIM_FLY_ATTACKFIST1HOFF               = 511,
    ANIM_PARRY_FIST1H                      = 512,
    ANIM_FLY_PARRYFIST1H                   = 513,
    ANIM_READY_FIST1H                      = 514,
    ANIM_FLY_READYFIST1H                   = 515,
    ANIM_SPECIAL_FIST1H                    = 516,
    ANIM_FLY_SPECIALFIST1H                 = 517,
    ANIM_EMOTE_READSTART                   = 518,
    ANIM_FLY_EMOTEREADSTART                = 519,
    ANIM_EMOTE_READLOOP                    = 520,
    ANIM_FLY_EMOTEREADLOOP                 = 521,
    ANIM_EMOTE_READEND                     = 522,
    ANIM_FLY_EMOTEREADEND                  = 523,
    ANIM_SWIMRUN                           = 524,
    ANIM_FLY_SWIMRUN                       = 525,
    ANIM_SWIM_WALK                         = 526,
    ANIM_FLY_SWIMWALK                      = 527,
    ANIM_SWIM_WALKBACK_WARDS               = 528,
    ANIM_FLY_SWIM_WALKBACKWARDS            = 529,
    ANIM_SWIM_SPRINT                       = 530,
    ANIM_FLY_SWIMSPRINT                    = 531,
    ANIM_MOUNT_SWIMIDLE                    = 532,
    ANIM_FLY_MOUNT_SWIMIDLE                = 533,
    ANIM_MOUNT_SWIMBACKWARDS               = 534,
    ANIM_FLY_MOUNTSWIMBACKWARDS            = 535,
    ANIM_MOUNT_SWIMLEFT                    = 536,
    ANIM_FLY_MOUNTSWIMLEFT                 = 537,
    ANIM_MOUNT_SWIMRIGHT                   = 538,
    ANIM_FLY_MOUNTSWIMRIGHT                = 539,
    ANIM_MOUNT_SWIMRUN                     = 540,
    ANIM_FLY_MOUNTSWIMRUN                  = 541,
    ANIM_MOUNT_SWIMSPRINT                  = 542,
    ANIM_FLY_MOUNTSWIMSPRINT               = 543,
    ANIM_MOUNT_SWIMWALK                    = 544,
    ANIM_FLY_MOUNTSWIMWALK                 = 545,
    ANIM_MOUNT_SWIMWALKBACKWARDS           = 546,
    ANIM_FLY_MOUNTSWIMWALKBACKWARDS        = 547,
    ANIM_MOUNT_FLIGHTIDLE                  = 548,
    ANIM_FLY_MOUNTFLIGHTIDLE               = 549,
    ANIM_MOUNT_FLIGHTBACKWARDS             = 550,
    ANIM_FLY_MOUNTFLIGHTBACKWARDS          = 551,
    ANIM_MOUNT_FLIGHTLEFT                  = 552,
    ANIM_FLY_MOUNTFLIGHTLEFT               = 553,
    ANIM_MOUNT_FLIGHTRIGHT                 = 554,
    ANIM_FLY_MOUNTFLIGHTRIGHT              = 555,
    ANIM_MOUNT_FLIGHTRUN                   = 556,
    ANIM_FLY_MOUNTFLIGHTRUN                = 557,
    ANIM_MOUNT_FLIGHTSPRINT                = 558,
    ANIM_FLY_MOUNTFLIGHTSPRINT             = 559,
    ANIM_MOUNT_FLIGHTWALK                  = 560,
    ANIM_FLY_MOUNTFLIGHTWALK               = 561,
    ANIM_MOUNT_FLIGHTWALKBACKWARDS         = 562,
    ANIM_FLY_MOUNTFLIGHTWALKBACKWARDS      = 563,
    ANIM_MOUNT_FLIGHTSTART                 = 564,
    ANIM_FLY_MOUNTFLIGHTSTART              = 565,
    ANIM_MOUNT_SWIMSTART                   = 566,
    ANIM_FLY_MOUNTSWIMSTART                = 567,
    ANIM_MOUNT_SWIMLAND                    = 568,
    ANIM_FLY_MOUNTSWIMLAND                 = 569,
    ANIM_MOUNT_SWIMLANDRUN                 = 570,
    ANIM_FLY_MOUNTSWIMLANDRUN              = 571,
    ANIM_MOUNT_FLIGHTLAND                  = 573,
    ANIM_FLY_MOUNTFLIGHTLAND               = 573,
    ANIM_MOUNT_FLIGHTLANDRUN               = 574,
    ANIM_FLY_MOUNTFLIGHTLANDRUN            = 575,
    ANIM_READY_BLOWDART                    = 576,
    ANIM_FLY_READYBLOWDART                 = 577,
    ANIM_LOAD_BLOWDART                     = 578,
    ANIM_FLY_LOADBLOWDART                  = 579,
    ANIM_HOLD_BLOWDART                     = 580,
    ANIM_FLY_HOLDBLOWDART                  = 581,
    ANIM_ATTACK_BLOWDART                   = 582,
    ANIM_FLY_ATTACKBLOWDART                = 583,
    ANIM_CARRIAGE_MOUNT                    = 584,
    ANIM_FLY_CARRIAG_EMOUNT                = 585,
    ANIM_CARRIAGE_PASSENGERMOUNT           = 586,
    ANIM_FLY_CARRIAGE_PASSENGERMOUNT       = 587,
    ANIM_CARRIAGE_MOUNTATTACK              = 588,
    ANIM_FLY_CARRIAGE_MOUNTATTACK          = 589,
    ...
    ANIM_FLY_BARTENDER_SHUFFLELEFT         = 597,
    ...
    ANIM_BARTENDER_EMOT_EPOINT             = 602,
    ANIM_FLY_BARTENDER_EMOTE_POINT         = 603,
    ANIM_BARMAIDSTAND                      = 604,
    ANIM_FLY_BARMAIDSTAND                  = 605,
    ANIM_BARMAIDWALK                       = 606,
    ANIM_FLY_BARMAIDWALK                   = 607,
    ANIM_BARMAIDRUN                        = 608,
    ANIM_FLY_BARMAIDRUN                    = 609,
    ANIM_BARMAIDSHUFFLELEFT                = 610,
    ANIM_FLY_BARMAIDSHUFFLELEFT            = 611,
    ANIM_BARMAIDSHUFFLERIGHT               = 612,
    ANIM_FLY_BARMAIDSHUFFLERIGHT           = 613,
    ANIM_BARMAIDEMOTETALK                  = 614,
    ANIM_FLY_BARMAIDEMOTETALK              = 615,
    ANIM_BARMAIDEMOTEPOINT                 = 616,
    ANIM_FLY_BARMAIDEMOTEPOINT             = 617,
    ANIM_MOUNTSELFIDLE                     = 618,
    ANIM_FLY_MOUNTSELFIDLE                 = 619,
    ANIM_MOUNTSELFWALK                     = 620,
    ANIM_FLY_MOUNTSELFWALK                 = 621,
    ANIM_MOUNTSELFRUN                      = 622,
    ANIM_FLY_MOUNTSELFRUN                  = 623,
    ANIM_MOUNTSELFSPRINT                   = 624,
    ANIM_FLY_MOUNTSELFSPRINT               = 625,
    ANIM_MOUNTSELFRUNLEFT                  = 626,
    ANIM_FLY_MOUNTSELFRUNLEFT              = 627,
    ANIM_MOUNTSELFRUNRIGHT                 = 628,
    ANIM_FLY_MOUNTSELFRUNRIGHT             = 629,
    ANIM_MOUNTSELFSHUFFLELEFT              = 630,
    ANIM_FLY_MOUNTSELFSHUFFLELEFT          = 631,
    ANIM_MOUNTSELFSHUFFLERIGHT             = 632,
    ANIM_FLY_MOUNTSELFSHUFFLERIGHT         = 633,
    ANIM_MOUNTSELFWALKBACKWARDS            = 634,
    ANIM_FLY_MOUNTSELFWALKBACKWARDS        = 635,
    ANIM_MOUNTSELFSPECIAL                  = 636,
    ANIM_FLY_MOUNTSELFSPECIAL              = 637,
    ANIM_MOUNTSELFJUMP                     = 638,
    ANIM_FL_YMOUNTSELFJUMP                 = 639,
    ANIM_MOUNTSELFJUMPSTART                = 640,
    ANIM_FLY_MOUNTSELFJUMPSTART            = 641,
    ANIM_MOUNTSELFJUMPEND                  = 642,
    ANIM_FLY_MOUNTSELFJUMPEND              = 643,
    ANIM_MOUNTSELFJUMPLANDRUN              = 644,
    ANIM_FLY_MOUNTSELFJUMPLANDRUN          = 645,
    ANIM_MOUNTSELFSTART                    = 646,
    ANIM_FLY_MOUNTSELFSTART                = 647,
    ANIM_MOUNTSELFFALL                     = 648,
    ANIM_FLY_MOUNTSELFFALL                 = 649,
    ANIM_STORMSTRIKE                       = 650,
    ANIM_FLY_STORMSTRIKE                   = 651,
    ANIM_READYJOUSTNOSHEATHE               = 652,
    ANIM_FLY_READYJOUSTNOSHEATHE           = 653,
    ANIM_SLAM                              = 654,
    ANIM_FLY_SLAM                          = 655,
    ANIM_DEATHSTRIKE                       = 656,
    ANIM_FLY_DEATHSTRIKE                   = 657,
    ANIM_SWIMATTACKUNARMED                 = 658,
    ANIM_FLY_SWIMATTACKUNARMED             = 659, //CTM 4.X.X END
    ...
    ANIM_FLYMONKOFFENSEATTACKWEAPON        = 775          //MOP 5.0.5B
};
...
enum LockType
{
    ...
    LOCKTYPE_PVP_OPEN_FAST         = 23                     //MOP 5.0.5B
};
...
enum CreatureFamily
{
    ...
    CREATURE_FAMILY_BASILISK            = 130,               //MOP 5.0.5B
};
...
enum QuestTypes
{
    ...
    QUEST_TYPE_ACCOUNT             = 102               //MOP 5.0.5B
};
...
enum QuestSort
{
    ...
    QUEST_SORT_MONK                = 395              //MOP 5.0.5B
};
...
inline uint8 ClassByQuestSort(int32 QuestSort)
{
    switch (QuestSort)
    {
        ...
        case QUEST_SORT_MONK:           return CLASS_MONK;           //MOP 5.0.5B
    }
    return 0;
}
...
enum SkillType
{
    ...
    SKILL_GOAT                     = 987,
    SKILL_BASILISK                 = 988,
    SKILL_NO_PLAYERS               = 999,   //MOP 5.0.5B
};

#define MAX_SKILL_TYPE               1000   //MOP 5.0.5B
...
enum SkillCategory                                         //SkillLineCategory.dbc not fond in client..may it only server side?
{
...
enum TotemCategory
{
    ...
    TC_JEWELERS_KIT                = 238,                   //MOP 5.0.5B
};
