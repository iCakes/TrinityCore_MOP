...
char const LFGDungeonEntryfmt[]="nxiiiiiiiiixxixixxxxxxx";
...
char const SpellCategoriesEntryfmt[]="nixiiiiiix";
const std::string CustomSpellDifficultyfmt="ppppp";
const std::string CustomSpellDifficultyIndex="id";
char const SpellDurationfmt[]="niii";
char const SpellEffectEntryfmt[]="nxifiiiffiiiiiifiifiiixixiiiix";
char const SpellEntryfmt[]="nssxxixxxiiiiiiiiiiiiiiii";
...
char const SpellItemEnchantmentfmt[]="nxiiiiiiiiisiiiiiiixxxxxx";
...
char const SpellPowerEntryfmt[]="nixiiiiixxxxx";
...
char const SpellCastingRequirementsEntryfmt[]="nixxixi";
char const SpellClassOptionsEntryfmt[]="nxiiiix";
